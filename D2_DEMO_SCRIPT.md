# TRACE.ai — D2 Frontend-Backend Demo Script (5-7 minutes)

**Format:** Screen share of https://trace-ai-4xnj5ovp4a-uc.a.run.app + voiceover
**Upload:** YouTube Unlisted
**Portal requirement:** Technical walkthrough — show model running, data flowing, narrate throughout
**Length:** Min 5 min, max 10 min
...
3. Paste the YouTube link in the **D2 "Frontend-Backend Demonstration Video"** field in the submission portal
4. Also add it to `README.md` under `## Live Demo` if the D5 video is not yet ready
